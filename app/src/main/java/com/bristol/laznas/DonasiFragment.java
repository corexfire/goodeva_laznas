...
//    private static final String DONASI_URL = "laznas/mobile/crowdfunding/donasi";
    ...
    private DonasiAdapter mAdapter;
    ArrayList<DonasiModel> donasi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootViewDonasi = inflater.inflate(R.layout.fragment_donasi, container, false);
        context = getContext();
        ...
        if(flag != 3){
            ...
            donasi = DonasiModel.createDonasiList(((LaznasApp) getActivity().getApplication()).getNidArray(),
    ...
    public void Donasi()
    {
        new DonasiFragment.AttemptDonasi(getActivity(), rootViewDonasi).execute("");
    }
    @Override
...
//            pDialogProfil3.dismiss();
            ...
            ((LaznasApp) getActivity().getApplication()).setFlag(3);
