...
public class DonasiAdapter extends
        RecyclerView.Adapter<DonasiAdapter.ViewHolder> implements Filterable {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            progress = (Button) itemView.findViewById(R.id.btn_input);
    ...
    private ArrayList<DonasiModel> mContacts;
    private ArrayList<DonasiModel> mArrayList;
    ...
    public DonasiAdapter(Context context, ArrayList<DonasiModel> contacts) {
        mArrayList = contacts;
        mContacts = contacts;
        mContext = context;
    }
    ...
    @Override
    public DonasiAdapter.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        DonasiAdapter.ViewHolder viewHolder = new DonasiAdapter.ViewHolder(contactView);
    ...
    @Override
    public void onBindViewHolder(DonasiAdapter.ViewHolder viewHolder, int position) {
        // Get the data model based on position
        final DonasiModel contact = mContacts.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (DonasiModel contact : mArrayList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mContacts = (ArrayList<DonasiModel>) filterResults.values;
