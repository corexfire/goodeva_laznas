...
public class DonasiModel {
    ...
    public DonasiModel(String nid, String name, String target, String batasWaktu, String deskripsi, String image, String terkumpul) {
        mNID = nid;
        mName = name;
        mTarget = target;
    ...
    public static ArrayList<DonasiModel> createDonasiList(ArrayList<String> nid,
        ...
        ArrayList<DonasiModel> donasiModels = new ArrayList<DonasiModel>();
        for (int i = 0; i < judul.size(); i++) {
            donasiModels.add(new DonasiModel("" + nid.get(i),
                    "" + judul.get(i),
                    "" + target.get(i),
                    "" + batasWaktu.get(i),
                    "" + deskripsi.get(i),
