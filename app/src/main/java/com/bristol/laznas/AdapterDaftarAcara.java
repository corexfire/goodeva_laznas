...
public class AdapterDaftarAcara extends BaseAdapter {
    int[] foto;
    String[] nama;
    String[] deskripsi;
    String[] waktu;
    ...
    public AdapterDaftarAcara(DaftarAcara daftarAcara, int[] fotoAcara, String[] namaAcara, String[] deskripsiAcara, String[] waktuAcara, String[] hargaAcara) {
