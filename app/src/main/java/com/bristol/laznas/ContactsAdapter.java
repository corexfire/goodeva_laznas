...
public class ContactsAdapter extends
    ...
    @Override
    public ContactsAdapter.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ContactsAdapter.ViewHolder viewHolder, int position) {
        ...
        TextView textViewBatasDonasi = viewHolder.batasDonasi;
        textViewBatasDonasi.setText(contact.getBatasWaktu());
        TextView textViewTargetDonasi = viewHolder.targetDonasi;
        ...
        //Picasso
        Picasso.with(mContext).load(imgUrl).into(viewHolder.image);
